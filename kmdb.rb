...
for role in my_roles
    my_movie = Movie.find_by({"id"=>role["movie_id"]})
    my_actor = Actor.find_by({"id"=>role["actor_id"]})
    puts "#{my_movie["title"]} #{my_actor["name"]} #{role["character_name"]}"
end
